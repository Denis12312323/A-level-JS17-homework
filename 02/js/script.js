...
const red = parseFloat(prompt('Количество красного цвета'));
const green = parseFloat(prompt('Количество зеленого цвета'));
const blue = parseFloat(prompt('Количество синего цвета'));
